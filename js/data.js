...
var EXHIBITS = {
  ...
  "MS-AE-003":{
    ...
    descKhm:"ការលង់ទឹកនៅតែជាមូលហេតុចម្បងមួយនៃការស្លាប់ដោយចៃដន្យ ជាពិសេសក្នុងចំណោមកុមារ ដែលគ្រោះថ្នាក់អាចបណ្តាលឱ្យស្លាប់ក្នុងរយៈពេលតិចជាង 30 វិនាទី។ ការត្រួតពិនិត្យរបស់មនុស្សតែម្នាក់ឯងគឺមិនអាចទុកចិត្តបានដោយសារតែការរំខាន ភាពអស់កម្លាំង និងបរិស្ថានមានមនុស្សច្រើនកុះករ ដែលធ្វើឱ្យអាងហែលទឹកជាច្រើនគ្មានការត្រួតពិនិត្យពេលវេលាជាក់ស្តែងប្រកបដោយប្រសិទ្ធភាព។ ប្រព័ន្ធដែលដំណើរការដោយបញ្ញាសិប្បនិម្មិតរបស់យើងដោះស្រាយបញ្ហានេះដោយតាមដានកាមេរ៉ា និងឧបករណ៍ចាប់សញ្ញាជាបន្តបន្ទាប់ ដើម្បីរកឃើញឥរិយាបថមិនធម្មតាដូចជា ភាពមិនអាចធ្វើចលនាបាន ការលិចទឹកយូរ ឬសញ្ញានៃការតស៊ូ។ នៅពេលដែលការគំរាមកំហែងត្រូវបានកំណត់ ប្រព័ន្ធនឹងបង្កឱ្យមានការជូនដំណឹងភ្លាមៗ និងធ្វើឱ្យការឆ្លើយតបសង្គ្រោះបន្ទាន់ដោយស្វ័យប្រវត្តិសកម្ម ដូចជាឧបករណ៍ជួយសង្គ្រោះ ឬជូនដំណឹងដល់បុគ្គលិកសង្គ្រោះបន្ទាន់ ដែលបង្កើនឱកាសនៃការជួយសង្គ្រោះទាន់ពេលវេលា និងកាត់បន្ថយឧប្បត្តិហេតុលង់ទឹក។",
    emoji:"🏊",
